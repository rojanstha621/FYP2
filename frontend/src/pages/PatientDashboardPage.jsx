    ...
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-md p-6 border-t-4 border-green-500">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">My Therapist</h2>
            {dashboardData?.assigned_therapist ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="mt-2 text-gray-500">No therapist assigned yet</p>
                <Link
                  to="/therapists"
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Today's Exercises</h2>
            <Link
              to="/exercises"
          ...
          {dashboardData?.today_exercises && dashboardData.today_exercises.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {dashboardData.today_exercises.map((exercise) => (
                ...
                >
                  ...
                  {exercise.status === 'PENDING' && (
                    <button className="mt-4 w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md text-sm font-medium transition-colors">
                      Start Exercise
                    </button>
                  )}
                  </div>
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-2 text-gray-500">No exercises assigned for today</p>
